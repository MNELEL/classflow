...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { path: '/curriculum',          icon: BookMarked, label: 'תכנון תוכנית לימודים',   desc: 'תכנון שבועי ויעדי לימוד',         color: 'bg-indigo-100 text-indigo-600 dark:bg-indigo-900/30 dark:text-indigo-400'   },
