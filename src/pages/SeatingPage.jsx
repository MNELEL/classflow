  ...
  return (
    <AppLayout>
      <div className="flex relative" style={{ height: 'calc(100dvh - 121px - env(safe-area-inset-top, 0px) - env(safe-area-inset-bottom, 0px))', minHeight: 0 }} dir="rtl">
        ...
        {/* Main grid */}
        <div ref={containerRef} className="flex-1 overflow-auto overflow-x-auto p-2 md:p-4 relative min-w-0 overscroll-y-contain" style={{ touchAction: 'pan-y', WebkitOverflowScrolling: 'touch', overscrollBehaviorY: 'contain' }}>
