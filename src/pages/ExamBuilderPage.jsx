...
export default function ExamBuilderPage() {
  ...
  const goBack = () => { if (step === 1) navigate('/question-bank'); else setStep(s => s - 1); };
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <h1 className="font-bold text-base flex items-center gap-1.5">
                  <FileText className="w-4 h-4 text-primary" /> בונה מבחנים
                </h1>
                <p className="text-xs text-muted-foreground">הרכבת מבחן מבנק השאלות</p>
              </div>
            </div>
            <Button variant="ghost" size="sm" className="text-xs h-8" onClick={() => navigate('/question-bank')}>
        ...
        <div className="flex-1 overflow-y-auto p-4">
          {isLoading ? (
            ...
            <div className="text-center py-20 text-muted-foreground">
              ...
              <Button size="sm" onClick={() => navigate('/question-bank')}>לבנק השאלות</Button>
            </div>
          ) : step === 1 ? (
