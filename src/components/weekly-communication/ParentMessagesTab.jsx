...
// Extracted from the former ParentPortalPage so it can live as a tab inside
// the unified weekly-communication hub. The hub (and the standalone
// /parents wrapper) supply the page chrome; this component renders only the
// student selector + parent-facing content (overview / PDF report / shared lessons).
  ...
  return (
    <div className="space-y-4" dir="rtl">
      <div className="flex items-center gap-2">
        ...
        <div>
          <h2 className="font-bold text-base">הודעות להורים</h2>
          <p className="text-xs text-muted-foreground">סקירת מידע, דוח PDF וסיכומים משותפים</p>
        </div>
      </div>
        ...
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-4">
          ...
          <Tabs defaultValue="overview" dir="rtl">
            ...
            <TabsContent value="report" className="mt-0">
              <StudentReportPDF student={student} grades={sGrades} attendance={sAttendance} rewards={sRewards} />
            </TabsContent>
