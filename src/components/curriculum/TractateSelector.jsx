      ...
      {open && (
        <div className="absolute top-full mt-1.5 right-0 z-50 bg-card border border-border rounded-xl shadow-lg p-3 w-72 space-y-2.5">
          ...
          <MobileSelect
            ...
            className="w-full text-xs h-9 border border-border rounded-lg bg-background"
          >
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              ...
              <MobileSelect value={fromDaf || '_none'} onValueChange={v => setFromDaf(v === '_none' ? '' : v)} placeholder="בחר..." className="w-full text-xs h-9 border border-border rounded-lg bg-background">
            ...
            <div>
              ...
              <MobileSelect value={toDaf || '_none'} onValueChange={v => setToDaf(v === '_none' ? '' : v)} placeholder="אחד בלבד" className="w-full text-xs h-9 border border-border rounded-lg bg-background">
