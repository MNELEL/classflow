...
export default function AppLayout({ children }) {
  ...
  const MORE_PATHS = [
    ...
    '/teacher-dashboard','/map','/weekly-sheet','/contact-sheet','/creation-center','/weekly-communication','/poll','/admin-overview','/certificates','/monthly-reports','/review','/templates',
  ];
