/**
 * תור סנכרון offline לכתיבות לא-רגישות (נוכחות, ציונים, אירועים, מערכת שבועית).
 *
 ...
 *
 * סוגי כתיבה נתמכים: 'attendance' | 'grade' | 'school_event' | 'weekly_plan'.
 * נוכחות/ציונים/אירועים/מערכת שבועית נבחרו כי הם פעולות שמורה יחיד
 * יוזם (לא משותפות בין מורים) או עם אפשרות upsert פשוטה לפי מפתח יחיד (תאריך
 * לנוכחות, שבוע למערכת) מבלי בדיקת קונפליקט מורכבת. לא מיועד להערות משמעת,
 * פרטי תלמיד רגישים או כל דבר שדורש בדיקת קונפליקט מורכבת (שני מורים
 * ערכים את אותו הרשומה בו-זמנית).
 */
